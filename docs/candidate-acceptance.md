...
- [ ] During keyboard movement, the default and precision-slow speeds hide the prominent trunk and companion arcs; holding any configured fast-speed key shows the complete trail again. Physical mouse movement remains eligible for the trail.
