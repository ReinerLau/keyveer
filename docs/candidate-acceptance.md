...
- [ ] Straight, curved, reversing, and closed-loop movement extend the same trunk along the complete motion route; bend positions, offsets, and 0.45–1.6× core widths are irregular, frozen once committed, and use the same position-independent two-dimensional offset distribution along the trunk.
